            ...
            <Sheet>
              ...
              <SheetContent className="overflow-y-auto">
                ...
                <div className="flex flex-col gap-6 p-4">
                  ...
                  >
                    Membership Portal <ArrowUpRight />
                  </Link>
                </div>
              </SheetContent>
            </Sheet>
...
const renderMenuItem = (item: MenuItem) => {
  ...
  return (
    <NavigationMenuItem key={item.title}>
      <NavigationMenuLink
        href={item.url}
        className="group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm text-white font-medium transition-colors hover:bg-white/20 hover:text-white/80"
      >
        {item.title}
      </NavigationMenuLink>
    </NavigationMenuItem>
