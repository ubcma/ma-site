...
const StatementSection = () => {
  ...
  return (
    <section id="statement" ref={ref}>
      <div className="relative h-[457px] mb-20">
        <img src="/image/team-page/statement-bg.webp" alt="Statement Background" className="absolute inset-0 w-full h-full object-cover" />
